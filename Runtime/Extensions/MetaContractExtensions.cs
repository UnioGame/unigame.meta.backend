namespace Extensions
{
    ...
    public static class MetaContractExtensions
    {
        ...
        public static Dictionary<string, ThrottleMetaContract> ThrottleMetaContracts = new();
        ...
        public static async UniTask<ContractMetaResult<TResult>> ExecuteAsync<TResult>(
            ...
            CancellationToken cancellationToken = default) where TResult : class
        {
            ...
            return await contract.ExecuteDebounceAsync<TResult>(contractId, DebounceMetaContract.DefaultInterval,
                cancellationToken);
        }
        ...
        public static async UniTask<ContractMetaResult<TOutput>> ExecuteThrottleAsync<TInput, TOutput>(
            this RemoteMetaContract<TInput, TOutput> contract,
            CancellationToken cancellationToken = default)
            where TOutput : class
        {
            return await contract.ExecuteThrottleAsync<TOutput>(cancellationToken);
        }
        
        public static async UniTask<ContractMetaResult<TResult>> ExecuteThrottleAsync<TResult>(
            this IRemoteMetaContract contract,
            CancellationToken cancellationToken = default) where TResult : class
        {
            var contractId = contract.Path;
            return await contract
                .ExecuteThrottleAsync<TResult>(contractId, ThrottleMetaContract.DefaultInterval,
                    ThrottleMetaContract.DefaultType, cancellationToken);
        }
            ...
            CancellationToken cancellationToken = default) where TResult : class
        {
            ...
            var result = await throttleMetaContract.ExecuteAsync(contract, cancellationToken);
